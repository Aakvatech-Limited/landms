...
function set_company_representative(frm) {
  ...
  frappe.call({
    method:
      "landms.landms.doctype.plot_handover.plot_handover.get_logged_in_representative_details",
    callback: function (r) {
...
function set_contract_details(frm) {
  ...
  frappe.call({
    method:
      "landms.landms.doctype.plot_handover.plot_handover.get_plot_handover_defaults",
    args: {
