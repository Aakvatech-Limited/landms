                ...
                callback(r) {
                  ...
                  if (result.ok) {
                    frappe.show_alert({
                      message:
                        result.message ||
                        __("Control number registered successfully."),
                      indicator: "green",
                    });
                  } else {
                    frappe.msgprint({
                      ...
                      message:
                        result.message ||
                        __(
                          "Registration failed. Check TCB API Log for details."
                        ),
                      indicator: "red",
                    });
                  }
                ...
                callback(r) {
                  ...
                  if (result.ok) {
                    frappe.show_alert({
                      message:
                        result.message ||
                        __("Control number declined successfully."),
                      indicator: "green",
                    });
                  } else {
                    frappe.msgprint({
                      ...
                      message:
                        result.message ||
                        __(
                          "TCB decline call failed. Check TCB API Log for details."
                        ),
                      indicator: "red",
                    });
                  }
